...
const MyAboutChannel = ({onClose, owners }) => {
    console.log(owners)
        ...
        <div className='about-channel'>
            ...
            <div className='about-channel-description'>
                ...
                <div className='about-full-info'>
                    ...
                    <span>
                        <FollowCount/>
                        {formatFollowersCount(owners.subscription)}
                    </span>

                    <span>
                        <VideoCount/>
                        {owners.videoCount} видео
                    </span>

                    <span>
                        <ViewCount/>
                        {addSpacesToNumber(owners.viewCount.toString())}
                        {owners.viewCount % 100 > 4 && owners.viewCount < 20
                            ? view[0]
                            : ` ${view[cases[Math.min(owners.viewCount % 10, 5)]]}`}
                    </span>

                    <span>
                        <RegistrationDate/>
                        Дата регистрации: {formatRegistration(owners.createdate)}
                    </span>
                    <span>
                        <GlobeCountry/>
                        {owners.country}
