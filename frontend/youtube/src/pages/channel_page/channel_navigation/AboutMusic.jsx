...
const AboutMusic = ({onClose, owners }) => {
    ...
    return(
        <>
            <div className='about-channel'>
                <svg xmlns="http://www.w3.org/2000/svg" className="close-icon" onClick={onClose} height="24"
                     viewBox="0 0 24 24"
                ...
                <div className='about-channel-description'>
                    ...
                    <div className='about-channel-references'>
                        <span>
                            Автоматически созданный канал YouTube
                        </span>
                        <a href=''>support.google.com/youtube/answer/2579942</a>
                    </div>
                    <h2>О канале</h2>
