	...
	const channels: ChannelShortType[] = [
		{
			...
			description:
				"Latest technology reviews, tutorials, and gadget overviews.",
			videoCount: 320,
		},
		{
			id: 2,
			...
			description:
				"Your daily dose of fitness routines, health tips, and nutrition.",
			videoCount: 540,
		},
		{
			id: 3,
		...
		},
		{
			...
			description:
				"Join us on amazing travel adventures and cultural experiences.",
			videoCount: 410,
		},
		{
			id: 5,
			...
			description:
				"Simplifying complex scientific concepts and theories for everyone.",
			videoCount: 180,
		},
	];
