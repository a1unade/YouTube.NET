          ...
          <div className="video-modal-window" style={{ padding: 20 }}>
            <div style={{ width: 130, marginBottom: 20 }}>
              <svg
                ...
                id="yt-logo-red-updated-svg_yt495"
            ...
            >
              <div style={{ fontSize: 18, textAlign: 'left' }} className="reports-block">
                <span>Чтобы скачать это видео подпишитесь на Premium</span>
              </div>
              <div style={{ fontSize: 16, textAlign: 'left' }} className="reports-block">
                <span>
                  Кроме того, вы сможете смотреть любимые ролики без рекламы, в фоновом режиме и
                  офлайн.
                </span>
              </div>
              <div className="report-buttons">
                ...
                <button onClick={() => setActive(false)} className="active">
                  Подробнее
                </button>
              </div>
            </div>
