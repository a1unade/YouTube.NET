  ...
  return (
    <div>
      <div
        ...
        role="dialog"
      >
        <div style={{ width: 550 }} className="modal-content" onClick={(e) => e.stopPropagation()}>
          <div className="share-modal-window">
            <div className="close-modal-button" onClick={() => setShareActive(false)}>
              <div>
                <span style={{ fontSize: 18 }}>Поделиться на вкладке "Сообщество"</span>
              </div>
            ...
            <div style={{ padding: 0, width: '100%' }} className="share-modal-window">
              <button className="share-post-button" onClick={handlePost}>
                Новая запись
              </button>
            </div>
            <span
                ...
                >
                  ...
                  >
                    ...
                    <g fill="none" fillRule="evenodd" id="soical" stroke="none" strokeWidth="1">
                      <g id="social" transform="translate(-973.000000, -538.000000)">
            ...
            <div className="share-link">
              <span>
                {link + 'shgbhsdbgdsbkgjsbdyguewbuygufhekfshdygfdsygfdhsgheakywehaywghvusdhguhsfg'}
              </span>
              <button onClick={handleShareButton} className="copy-link-button">
                Копировать
              </button>
            </div>
          </div>
