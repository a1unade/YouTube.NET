			...
			{isOpen ? (
				<div className="left-menu">
					<div className="sidebar-container">
						...
						<div className="first-container">
							<div className="best-youtube-section-title-container">
								<p className="youtube-title-style"></p>
							</div>
							<MenuButton
						...
						<div className="content-section-with-links-and-copyright">
							...
							<a href="https://www.youtube.com/about/press/">
								Прессе
							</a>
							<a href="https://www.youtube.com/about/copyright/">
								Авторские права
							</a>
						...
						<div className="content-section-with-links-and-copyright">
							...
							<p className="copyright-text-styling">
								© 2024 Google LLC Youtube, компания Google
							</p>
						</div>
					</div>
				</div>
