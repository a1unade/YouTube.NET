...
export const SettingsIconFilled = () => {
	return (
		<svg
			...
			aria-hidden="true"
		>
			<path d="M19.56 12c0-.39-.03-.77-.09-1.14l2.19-2.13-2-3.46-2.92.83c-.6-.48-1.27-.87-2-1.14L14 2h-4l-.74 2.96c-.73.27-1.4.66-2 1.14l-2.92-.83-2 3.46 2.19 2.13c-.06.37-.09.75-.09 1.14s.03.77.09 1.14l-2.19 2.13 2 3.46 2.92-.83c.6.48 1.27.87 2 1.14L10 22h4l.74-2.96c.73-.27 1.4-.66 2-1.14l2.92.83 2-3.46-2.19-2.13c.06-.37.09-.75.09-1.14zM12 16c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"></path>
		</svg>
	);
};
...
export const SubscriptionsIcon = () => {
	return (
		...
		>
			<g
				id="Ico / Subscriptions"
				data-node-id="I8:86;209:1493"
				xmlns="http://www.w3.org/2000/svg"
			>
...
export const PlaylistIconFilled = () => {
	return (
		<svg
			...
			aria-hidden="true"
		>
			<path d="M15 19v-8l7 4-7 4Zm7-12H2v2h20V7Zm-9 6H2v-2h11v2Zm0 4H2v-2h11v2Z"></path>
		</svg>
	);
};
