...
namespace YouTube.Persistence.Migrations
{
    ...
    [Migration("20240512235059_updateStaticProp")]
    partial class updateStaticProp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YouTube.Domain.Entities.StaticFile", b =>
                {
                    ...
                    b.Property<int?>("BannerChannelId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("YouTube.Domain.Entities.StaticFile", b =>
                {
                    b.HasOne("YouTube.Domain.Entities.Channel", "BannerImg")
                        .WithOne("BannerFile")
                        .HasForeignKey("YouTube.Domain.Entities.StaticFile", "BannerChannelId");

                    b.HasOne("YouTube.Domain.Entities.Channel", "ChannelMainImg")
                        .WithOne("MainImgFile")
                        .HasForeignKey("YouTube.Domain.Entities.StaticFile", "MainChannelId");

                    b.HasOne("YouTube.Domain.Entities.Video", "Video")
                        .WithOne("StaticFile")
                        .HasForeignKey("YouTube.Domain.Entities.StaticFile", "VideoId");

                    b.Navigation("BannerImg");

                    b.Navigation("ChannelMainImg");
