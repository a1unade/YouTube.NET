...
namespace YouTube.Persistence.Migrations
{
    ...
    [Migration("20240512233849_updateStatic")]
    partial class updateStatic
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("YouTube.Domain.Entities.StaticFile", b =>
                {
                    b.HasOne("YouTube.Domain.Entities.Channel", "Channel")
                        .WithOne("MainImgFile")
                        .HasForeignKey("YouTube.Domain.Entities.StaticFile", "ChannelId");

                    b.HasOne("YouTube.Domain.Entities.Channel", null)
                        .WithOne("BannerFile")
                        .HasForeignKey("YouTube.Domain.Entities.StaticFile", "ChannelId1");
