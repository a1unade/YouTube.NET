        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubCount = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    MainImgId = table.Column<Guid>(type: "uuid", nullable: false),
                    BannerImgId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubscriberChannelId = table.Column<Guid>(type: "uuid", nullable: false),
                    SubscribedToChannelId = table.Column<Guid>(type: "uuid", nullable: false),
                    ChannelId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChannelSubscriptions", x => new { x.SubscribedToChannelId, x.SubscriberChannelId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ChannelSubscriptions_Channels_SubscribedToChannelId",
                        column: x => x.SubscribedToChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChannelSubscriptions_Channels_SubscriberChannelId",
                        column: x => x.SubscriberChannelId,
                        principalTable: "Channels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChannelId = table.Column<Guid>(type: "uuid", nullable: false),
                    IsHidden = table.Column<bool>(type: "boolean", nullable: false),
                    Age = table.Column<short>(type: "smallint", nullable: false, defaultValue: (short)0),
                    PreviewImgId = table.Column<Guid>(type: "uuid", nullable: false),
                    VideoUrlId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Videos_Files_PreviewImgId",
                        column: x => x.PreviewImgId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Videos_Files_VideoUrlId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelSubscriptions_SubscriberChannelId",
                table: "ChannelSubscriptions",
                column: "SubscriberChannelId");
