        ...
        <>
            ...
            <div className="input-container">
                <div className="birth-date">
                    <div className="input-container" style={{ margin: 0 }}>
                        <input type="tel" value={day} id="day" maxLength={2} placeholder="День" onChange={(e) => setDay(e.target.value)} style={{ marginLeft: 0 }}></input>
                        <label>День</label>
                    </div>
                    <div className="input-container" style={{ margin: 0 }}>
                    ...
                    <div className="input-container" style={{ margin: 0 }}>
                        <input type="tel" value={year} id="year" onChange={(e) => setYear(e.target.value)} maxLength={4} placeholder="Год"></input>
            ...
            <div className="input-container" style={{ marginTop: 10 }}>
                ...
                <div id="gender-error" className="error-message hidden">
                    ...
                    <span id="gender-message"></span>
                </div>
                <a href="https://support.google.com/accounts/answer/1733224?hl=ru"><b>Почему мы просим указать дату рождения и пол</b></a>
            </div>
